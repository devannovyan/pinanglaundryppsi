...
<body>
   ...
   <section class="py-5">
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Cara Pesan Self-Service</h2>
                <p class="text-muted col-lg-7 mx-auto">Ikuti 4 langkah mudah ini untuk menikmati layanan laundry kami yang cepat dan praktis.</p>
            </div>
            <div class="row g-4 justify-content-center align-items-stretch">
                <div class="col-md-3 col-6">
                    <div class="tutorial-step">
                        ...
                        <h5 class="fw-bold">Pilih Mesin Cuci</h5>
                        <p class="text-muted small">Pilih mesin cuci yang ingin dibooking.</p>
                    </div>
                </div>
                <div class="col-md-3 col-6">
                    <div class="tutorial-step">
                ...
                <div class="col-md-3 col-6">
                    <div class="tutorial-step">
                        ...
                        <h5 class="fw-bold">Bayar</h5>
                        <p class="text-muted small">Lakukan pembayaran dan dapatkan kode pemesanan.</p>
                    </div>
                </div>
                <div class="col-md-3 col-6">
                    <div class="tutorial-step">
                        ...
                        <h5 class="fw-bold">Datang ke Lokasi</h5>
                        <p class="text-muted small">Datang ke lokasi dalam waktu 30 menit, tunjukkan kode pemesanan pada staff dan gunakan mesin cuci yang sudah dibooking.</p>
                    </div>
                </div>
            </div>
